...
let apiKey = "5708da145a678bec173f858c08d121c9";

// let apiKey = ''
function getMovies(searchText) {
    axios.get("https://api.themoviedb.org/3/search/movie?api_key=" + apiKey + "&language=en-US&query=" + searchText)
    .then((response)=>{
            ...
            <div class = "col-md-8">
                <h2>${movie.title}</h2>
                    <ul class = "list-group">
                        ...
                        <li class = "list-group-item"> <strong> Rated: </strong> ${movie.popularity }</li>
